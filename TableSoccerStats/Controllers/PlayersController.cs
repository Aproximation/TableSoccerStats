...
namespace TableSoccerStats.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FirstName,LastName,Email")] NewPlayerInfo playerInfo)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                player.Initials = GetInitials(player.FirstName, player.LastName);
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public ActionResult Edit([Bind(Include = "PlayerId,FirstName,LastName,Email,Initials,Created")] Player player)
        //{
        //    if (ModelState.IsValid)
        //    {
